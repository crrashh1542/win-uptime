   ...
   <fluent-dialog id="setting" trap-focus hidden modal>
      <div class="container">
         ...
         <div class="flex section">
            ...
            <fluent-switch
               checked="true"
               v-model="isShowFlight"
               @click="changeStatus(0, isShowFlight)"
            ></fluent-switch>
         </div>
         ...
         <div class="flex section">
            ...
            <fluent-switch
               checked="true"
               v-model="isShowBranch"
               @click="changeStatus(1, isShowBranch)"
            ></fluent-switch>
         </div>

         <div class="button">
            <fluent-button appearance="accent" @click="dialogClose()"
               >关闭</fluent-button
            >
         </div>
      </div>
